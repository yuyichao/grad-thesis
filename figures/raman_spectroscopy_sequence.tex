...
\begin{tikzpicture}[scale=1.5]
  % Legends
  \draw[line width=1,blue,opacity=0.6] (0.3, 1.85) -- ++(0.6, 0) node[right,black,opacity=1] {$\mathrm{P_{down}}$};
  \draw[line width=1,orange,opacity=0.7] (1.8, 1.85) -- ++(0.6, 0) node[right,black,opacity=1] {$\mathrm{P_{up}}$};
  \draw[line width=1,purple] (3.3, 1.85) -- ++(0.6, 0) node[right,black,opacity=1] {$\mathrm{P_{total}}$};

  % Y (power) markers
  \draw[line width=0.5,dashed] (4.3, 1.0) -- (0.7, 1.0) node[below] {\small $\mathrm{P_{Raman}}$};
