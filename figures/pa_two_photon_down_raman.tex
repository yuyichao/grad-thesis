...
\begin{tikzpicture}
  \draw[->, line width=2] (-0.3, -2) -- node[rotate=90,above] {Energy} (-0.3, 4.9);
  \begin{scope}[shift={(0.3, 0)}]
    \draw[line width=1] (0.5, -0.8) node[left] {$|m\rangle$} -- (7.8, -0.8);
    \draw[line width=1] (0.5, 0) node[left] {$|g\rangle$} -- (7.8, 0);
    \draw (0.5, 0.1) -- (7.8, 0.1);
    \draw (0.5, 0.6) -- (7.8, 0.6);
    \fill[opacity=0.2] (0.5, 0.7) rectangle (7.8, 1.2);
    \draw[densely dotted,line width=0.7] (7.8, 0.7) -- (8.0, 0.7);
    \draw[line width=1] (0.5, 3.5) node[left] {$|e\rangle$} -- (7.8, 3.5);
    \draw[decoration={brace,mirror,raise=1pt, amplitude=3pt},decorate,line width=0.8]
    (7.85, 0) -- node[right=4pt] {\scriptsize Trap States} (7.85, 0.67);
    \draw[->,line width=0.8] (7.9, 0.7) --
    node[right] {\scriptsize Continuum} (7.9, 1.4);
