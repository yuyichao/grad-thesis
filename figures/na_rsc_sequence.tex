...
\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \node[above,blue,align=center] at (2.8*2+0.8, 1) {Axial $z$};
    \foreach \i in {0,...,3} {
      \node[below,blue,align=center] at (5.6*\i + 0.8, -0.15) {\textbf{$m$-th}\\\textbf{order}};
      \node[below,blue,align=center] at (5.6*\i + 3.6, -0.15)
      {\textbf{$(\!m-1\!)$-th}\\\textbf{order}};
    }
    ...
    \node[above,red,align=center] at (5.6*1+2.2, 1.5) {Radial $x$};
    \node[below,red,align=center] at (5.6*1+2.1, 0.05) {\textbf{pulse $1$}};
    \node[below,red,align=center] at (5.6*2+2.1, 0.05) {\textbf{pulse $2$}};
    ...
    \node[above,align=center] at (5.6*1+5.0, 1.5) {Radial $y$};
    \node[below,align=center] at (5.6*1+5.2, 0.05) {\textbf{pulse $1$}};
    \node[below,align=center] at (5.6*2+5.2, 0.05) {\textbf{pulse $2$}};
  ...
  \node[rotate=180] at (17.305, 0.655)
  {\includegraphics[width=1.01cm, height=5.71cm]{fadings/fade_img.png}};
  \node at (5.095, 0.655)
  {\includegraphics[width=1.01cm, height=5.71cm]{fadings/fade_img.png}};

  \node[left,purple,align=center] at (5.0, 2.3) {\textbf{Tweezer}};
  \node[left,align=center] at (4.8, 0.5) {\textbf{Raman}};
  \node[left,orange,align=center] at (5.15, -1.5) {\textbf{Optical}\\\textbf{pumping}};
