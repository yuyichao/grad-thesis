\documentclass[border={0pt -2pt 0pt -9pt}]{standalone}
...
\begin{tikzpicture}[scale=0.65]
  ...
  \node[left, red!60!black] at (-1, 0.7) {$\mathrm{3^2S_{1/2}}$};
  ...
  \node[left, red!60!black] at (-1, 4.1) {$\mathrm{3^2P_{3/2}}$};

  % F2 Raman
  \draw[<->, line width=0.7, >=stealth, orange] (0, 0.9 - 1) -- (0.72, 3.6);
  \node[orange,above left] at (0.75, 2.6) {$\Omega_{\mathrm{F2}}$};
  ...
  \node[red,right] at (2.05 - 0.65, 0.5) {$\Omega_{\mathrm{F1}}$};
  ...
  % P1/2
  \node[below right, red!60!black] at (1.2, 2.98) {$\mathrm{3^2P_{1/2}}$};
  ...
  \node[right, blue] at (3.35, 1.5) {$\Gamma_{\mathrm{OP}}$};
\end{tikzpicture}
\end{document}
