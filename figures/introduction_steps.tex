...
\begin{document}
\begin{tikzpicture}
  \node[left,align=center] at (-2, 2.4) {\textbf{Loading and}\\\textbf{Cooling}};
  \node[left] at (-2, 0) {\textbf{Merging}};
  \node[left,align=center] at (-2, -2.4) {\textbf{Weakly Bound}\\\textbf{Molecules}};
  \node[left,align=center] at (-2, -4.8) {\textbf{Rovibronic Ground}\\\textbf{State Molecules}};
  \foreach \x in {0, 1, 2} {
    \begin{scope}[shift={(\x * 3.5, 0)}]
