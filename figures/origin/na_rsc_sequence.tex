...
\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    \path[blue] (2.8*2+0.8, 1) node[above,align=center] {Axial $z$};
    \foreach \i in {0,...,3} {
    ...
    \path[red] (5.6*1+2.2, 1.5) node[above,align=center] {Radial $x$};
    ...
    \path[black] (5.6*1+5.0, 1.5) node[above,align=center] {Radial $y$};
