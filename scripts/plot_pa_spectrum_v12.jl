...
const names_files = ["nacs_201911/data/names_20191121_201825.mat"
                     "nacs_201911/data/names_20191122_002635.mat"]
...
const prefix = joinpath(@__DIR__, "../figures/pa_spectrum_v12")
...
annotate("", xy=(492.08, 0.06), xytext=(492.08, 0.11), arrowprops=ptrprops)
annotate("", xy=(495.88, 0.05), xytext=(495.88, 0.10), arrowprops=ptrprops)
annotate("", xy=(502.00, 0.07), xytext=(502.00, 0.02), arrowprops=ptrprops)
grid()
ylim([0, 0.73])
xlabel("PA Frequency (306XXX GHz)")
