...
const prefix = joinpath(@__DIR__, "../figures/raman_spectroscopy_n2_fit")

plotx, plote1, plote2, plote3 = eval_model_power(linspace(3.5, 13, 1000), 1.0, fit.param)

figure()
plot(plotx, plote1, "C0")
plot(plotx, plote2, "C1")
plot(plotx, plote3, "C2")
errorbar(freqs10[1:3:end, 1], freqs10[1:3:end, 3], freqs10[1:3:end, 4], fmt="C0o")
errorbar(freqs10[2:3:end, 1], freqs10[2:3:end, 3], freqs10[2:3:end, 4], fmt="C1o")
errorbar(freqs10[3:3:end, 1], freqs10[3:3:end, 3], freqs10[3:3:end, 4], fmt="C2o")
grid()
xlabel("Tweezer Power (mW)")
ylabel("Raman Resonance (MHz)")
NaCsPlot.maybe_save("$(prefix)_b10")

plotx, plote1, plote2, plote3 = eval_model_power(linspace(1.5, 8.6, 1000), 0.6, fit.param)

figure()
plot(plotx, plote1, "C0")
plot(plotx, plote2, "C1")
plot(plotx, plote3, "C2")
errorbar(freqs06[1:3:end, 1], freqs06[1:3:end, 3], freqs06[1:3:end, 4], fmt="C0o")
errorbar(freqs06[2:3:end, 1], freqs06[2:3:end, 3], freqs06[2:3:end, 4], fmt="C1o")
errorbar(freqs06[3:3:end, 1], freqs06[3:3:end, 3], freqs06[3:3:end, 4], fmt="C2o")
grid()
xlabel("Tweezer Power (mW)")
ylabel("Raman Resonance (MHz)")
