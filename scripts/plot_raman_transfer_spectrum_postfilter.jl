...
const data = read_csv_compressed(
    joinpath(@__DIR__, "../data/Timebase1038ASE_20200718_193100/data.csv.zst"), ',', Float64)
# const axis = read_csv_compressed(
#     joinpath(@__DIR__, "../data/Timebase1038ASE_20200718_193100/axis.csv.zst"), ',', Float64)
