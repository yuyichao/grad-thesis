...
which is a property that needs to be ensured in the experiment (see section \ref{ch:rsc:calibration}).
...
\section{Calibration}
\label{ch:rsc:calibration}

(Sideband/carrier)
(off resonance coupling, Blackman pulse shape)
(Cold vs hot)
\todo{Anharmonicity}
