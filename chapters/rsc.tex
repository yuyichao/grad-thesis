...
\begin{figure}
  \centering
  \includegraphics[width=16cm]{figures/na_rsc_challenges.pdf}
...
\begin{figure}
  ...
  \caption[Simulation optimized Raman sideband cooling sequence for Sodium]{
    ...
    while the measurement Rabi pulses in Fig.\todo{~\ref{f-radial}(B,C)}
    and \todo{\ref{f-axial}(B,C)}
...
\begin{figure}
  ...
  \caption[Raman sideband spectra before and after cooling]{
    Raman sideband spectra for (A) $z$, (B) $x$, (C) $y$ axis before and after applying
    Raman sideband cooling sequence. The height of the cooling sidebands (positive detuning)
