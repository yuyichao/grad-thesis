...
correspond to ground-state fractions of $98.1(5)~\%$ and $97.6(3)~\%$,
...
which corresponds to a ground state population of $97.6(5)~\%$,
in agreement with a ground state population of $95(4)~\%$ extracted from Rabi flopping
...
($0.1-0.2~\mathrm{kHz}$) from the Raman beams,
