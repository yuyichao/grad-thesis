...
$|s_1\rangle\equiv|F=2,m_F=2\rangle$ hyperfine state,
and a Raman transition is used to drive the atom to the
$|s_2\rangle\equiv|F=1,m_F=1\rangle$ state.
...
A closed form result for this is given in \todo{\cite{}},
...
the three terms corresponds to the carrier ($\Delta n=0$),
the first order heating sideband ($\Delta n=1$)
and the first order cooling sideband ($\Delta n=-1$) with corresponding strength
