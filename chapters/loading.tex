...
\todo{
  Cooling, and therefore loading and imaging,
  in tweezer using the free-space cooling beams works well for Cs.
  ...
  and the absense of an accessible magic wavelength causes a significant (\todo{number}?)
  ...
  Tweezer parameters: NA, waist, power calibration (for the rest of the thesis), uncertainty
}
...
\todo{
  ...
  cite Lee's thesis
  Image of atoms
  Guarantee load of atoms in their respective tweezer
}
