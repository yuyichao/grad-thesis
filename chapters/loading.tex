...
In addtional to loading, the imaging process further constraint the available parameters
for the tweezer. We use florescence imaging to detect the atoms in the tweezer.
In order to prevent the photon recoil from heating the atom out of the tweezer
before enough photons can be collect,
the trap depth must be much higher compared to the temperature of the atom.
We can estimate this requirement as follows.
