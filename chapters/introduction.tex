...
Chapter \ref{ch:apparatus} discusses the basic beam path setup in the experiment
for cooling and trapping of the atoms.
This also serves as a summary for the preparation steps of the experiment that is
not covered by this thesis.

Chapter \ref{ch:computer-control} gives a high level description of the custom
