...
\todo{
  As a result, two approach
  1. direct cooling using diagonal molecules: achieving similar cooling performance
  with a relatively small photon scattering budget.
