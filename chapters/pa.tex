...
Fig~.\todo{\ref{}} shows the spectrum for the same PA line with
$...\todo{} \mathrm{mW}$ tweezer power with a significantly narrower linewidth.
We therefore measured the dependency of the linewidth on the tweezer power
and the result is shown in Fig~.\todo{\ref{}} suggesting
that the linewidth is proportional to the tweezer power.
