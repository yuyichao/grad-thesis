...
\begin{figure}
  ...
  \caption[Two-photon transition from molecular state.]{
    ...
    Note that none of the two-photon transitions from $|m\rangle$ ends up in
...
As shown in Fig.~\ref{fig:pa:linewidth:two-photon-down-raman},
