...
\begin{table}
  ...
  \caption[Binding energies for $v''=-1,\ N=0$ states]{
    ...
    The experimentally measured resonances have a AC Stark shift in the range of
    $10~\mathrm{kHz}$ to $10~\mathrm{MHz}$ that depends on the tweezer power and frequency.
    We obtain the bare resonant frequency by measuring the resonance at different tweezer powers
    and extrapolate to zero trap power.
    An example of such analysis is given in section~\ref{ch:raman-transfer:results:scaling}.
