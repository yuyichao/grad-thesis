...
\begin{figure}
  ...
  \caption[Interaction shift measurement results.]{
    (A, C) Interaction shift measurement for
    ...
    by the interaction.
    (B, D) The corresponding transition on the energy map from theoritical calculation.
    Only states with the same parity are shown.
...
(Fig.~\ref{fig:interaction-shift:results}D).
