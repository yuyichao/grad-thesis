...
but there are also many relative motional states
which have zero overlap with the $\delta$-function, and therefore are unaffected.
...
one but not the other atom using a Raman transition.
