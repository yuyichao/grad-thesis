...
to the scattering length directly through the two-scale single-channel quantum defect theory (QDT).
...
The final result for all the spin states is summarized in table~\ref{table:interaction-shift:results}.

\section{Summary and Outlook}

\todo{
  prediction of FB resonance
