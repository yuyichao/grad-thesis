...
The USRP device does not have builtin support for triggering,
...
However, most experiments requires running multiple sequences
for reducing statistical uncertainty and to measure the effect of varying certain parameters.
