...
\todo{
  ...
  and Rabi frequency, we will also use data that includes no ASE filter.
  ...
  We fit the four parameters by fitting the .... to a ... model.
  Additionally, since the atomic loss rate is slow compared to the Raman transition time,
  we measure it separately using the two-body lifetime of the atoms to obtain a more accurate number.
}
