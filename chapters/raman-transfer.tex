...
On the other hand, the total scattering rate (Fig.~\ref{fig:raman-transfer:raman:extra-ext-states}B)
...
As an example, the blue and orange maxima in Fig.~\ref{fig:raman-transfer:raman:extra-ext-states}C
...
As is the case for Raman transition\textsuperscript{(\ref{ch:raman-transfer:raman:cross-couple})},
...
\begin{figure}
  ...
  as intermediate state for the Raman transition]{
    ...
    ($\Omega_{\mathrm{R}}$) compared to the (B) weakly bound excited state ($v'=63$)
    at a given detuning.
