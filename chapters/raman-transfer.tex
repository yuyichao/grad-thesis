...
is directly related to the excited state lifetime, the maximum usuable detuning
and the excited state linewidth.
...
via pre-dissociation which significantly increases the linewidth.
