...
\subsection{Loss During STIRAP for Ideal Three-Level System}

During STIRAP, the wavefunction amplitude in the final state $c_f$
...
These give us a lower bound on the scattering probability,
\begin{align*}
