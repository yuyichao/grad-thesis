...
\todo{
  ...
  In the study below, we will treat the contribution from other states as constants
  over the range of frequencies we scan and fit the detuning depdnency of each parameters
