...
\todo{
  Refer beam path/sequence
  Same sequence as Raman spectroscopy,
  Use interaction shift to prepare initial state
  larger detuning/shorter time to obtain a narrower linewidth.
  Got Fourier limited linewidth (factor of 0.8?)
  Signal that the transfer is in coherent regime.
  Got Rabi flopping.
