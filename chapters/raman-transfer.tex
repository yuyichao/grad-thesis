...
An example of such fitting is shown in Fig.~\todo{ref} and \todo{ref}
...
The fit is shown in Fig.~\todo{ref}A with Fig.~\todo{ref}B showing
the near linear dependency of the light shift on the tweezer power.
The fitting parameters is as follows,
\todo{parameters, note that the parameters uses angular frequency whereas the light shift
  and detuning use real frequency}
...
This is shown in Fig.~\todo{ref}A and the fitting parameters are,
\todo{parameters}
...
by $\todo{number}~\mathrm{\%}$ in Fig.~\todo{ref Rabi flopping}.
...
\begin{figure}
  \centering
  \includegraphics[width=0.7\textwidth]{figures/raman_transfer_scatter_scaling_mol.pdf}
  \caption[Molecular scattering rate as a function of tweezer power and frequency]{
    Dependency of molecular scattering rate $\Gamma_{\mathrm{m}}$
    on tweezer power and frequency on a log-log scale.
    ...
    part of the scattering is related to the $v'=0$ excited state.
...
as shown in Fig.~\ref{fig:raman-transfer:results:scaling:gamma-mol}.
