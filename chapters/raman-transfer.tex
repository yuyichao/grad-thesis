...
and the properties we can directly measure from the transitions are
the resonance frequency~(i.e. light shift of the transition),
Raman Rabi frequency, and the two scattering rates for the atomic and molecular states.
