...
we get a scattering rate of $\Gamma_{\mathrm{m}}^{\mathrm{2-photon}}=2\pi\times2~\mathrm{kHz}$.
This proofs that the this mechanism can indeed cause the observed scattering rate.
...
This could also be done by changing the directly of the magnetic field.
...
The resulting Rabi frequencies matches quite well with the theory prediction
but we the scattering rate is much higher than expected.
