...
\begin{align*}
  \min\paren{p_{scatter}}=&\frac{4\Gamma_e}{\min\paren{\Omega_1^2}T}
\end{align*}
...
\begin{align*}
  ...
  =&\frac{\Gamma'_e}{4{\omega'_e}^2}\paren{\frac{\Omega'_1}{\Omega_1}-\frac{\Omega'_2}{\Omega_2}}^2\int_0^T \frac{\Omega_1^2(t)\Omega_2^2(t)}{\Omega_1^2(t)+\Omega_2^2(t)} \ud t\\
  =&C'\frac{\Gamma'_e\paren{\Omega_1^2+\Omega_2^2}T}{4{\omega'_e}^2}\paren{\frac{\Omega'_1}{\Omega_1}-\frac{\Omega'_2}{\Omega_2}}^2
\end{align*}
...
\begin{align*}
  C'\equiv&\frac{1}{T}\int_0^T \frac{\Omega_1^2(t)\Omega_2^2(t) \ud t}{\paren{\Omega_1^2(t)+\Omega_2^2(t)}\paren{\Omega_1^2+\Omega_2^2}}
\end{align*}
...
\begin{align*}
  ...
  =&\frac{\Gamma_e\paren{\Omega_1^2+\Omega_2^2}T}{4\delta^2}\paren{C''_1\frac{M_2^2}{M_1^2}+C''_2\frac{M_1^2}{M_2^2}}
\end{align*}
where $C''_1$ and $C''_2$ are two dimentionless numbers
depending only on the pulse shape defined as,
\begin{align*}
  C''_i\equiv&\frac{1}{T}\int_0^T \frac{\Omega_i^4(t) \ud t}{\paren{\Omega_1^2(t)+\Omega_2^2(t)}\paren{\Omega_1^2+\Omega_2^2}}
\end{align*}

\subsection{Conclusion}

\todo{mention use of tweezer as Raman}
\todo{mention light shift which is worse for imbalanced coupling and large decay rate}
\todo{Since the light shift depends on the power of the two beams,
  it is not a constant during STIRAP so the frequencies of the two beams have to be
  varied in additional to the power ramp.}
